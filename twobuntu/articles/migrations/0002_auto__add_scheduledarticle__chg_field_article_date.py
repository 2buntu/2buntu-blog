...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'articles_article', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting model 'ScheduledArticle'
        db.delete_table(u'articles_scheduledarticle')


        # Changing field 'Article.date'
        db.alter_column(u'articles_article', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    models = {
        u'articles.article': {
            'Meta': {'ordering': "('status', '-date')", 'object_name': 'Article'},
